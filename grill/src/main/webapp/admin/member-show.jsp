    ...
    <body>
        <div class="x-body">
            <blockquote class="layui-elem-quote">
                <img src="${pageContext.request.contextPath}/admin/images/logo.png" class="layui-circle" style="width:50px;float:left">
                <dl style="margin-left:80px; color:#019688">
                <dt><span>${user.name}</span></dt>
                <dd style="margin-left:0"><c:if test="${empty user.message}">这家伙很懒，什么也没有留下</c:if><c:if test="${!empty user.message}">${user.message}</c:if></dd>
              </dl>
            </blockquote>
            <div class="pd-20">
